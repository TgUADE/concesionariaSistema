...
public class ConcretePedidoBuilder implements InterfazPedidoBuilder {
    ...
    @Override
    public Pedido build() throws ExcepcionValidacion { // Added throws
        // Basic validation for required fields
        if (cliente == null || vehiculo == null || servicioDePago == null || servicioDeNotificacion == null || fechaCreacion == null) {
            throw new ExcepcionValidacion("Campos obligatorios no fueron establecidos para construir el Pedido. Cliente, Vehículo, ServicioDePago y ServicioDeNotificacion son requeridos.");
        }
