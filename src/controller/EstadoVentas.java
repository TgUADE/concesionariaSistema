...
public class EstadoVentas implements InterfazEstadoPedido {
    ...
    @Override
    public void retroceder(Pedido pedido, Object contexto) throws ExcepcionProceso { // Added throws
        throw new ExcepcionProceso("No se puede retroceder desde el estado Ventas para el pedido " + (pedido != null ? pedido.getNumeroPedido() : "N/A") + ".");
    }
