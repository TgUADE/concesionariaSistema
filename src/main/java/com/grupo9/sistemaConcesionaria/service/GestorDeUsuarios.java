...
/**
 * Gestor de usuarios y clientes implementando el patrón Singleton
 * Maneja clientes y usuarios del sistema (Administradores, Vendedores)
 */
@Service
public class GestorDeUsuarios implements InterfazGestorDeUsuario {

    private static GestorDeUsuarios instancia;
    private HashMap<String, Cliente> clientes; // Key: documento del cliente
    private HashMap<String, Usuario> usuariosDelSistema; // Key: mail del usuario

    /**
     * Constructor privado para patrón Singleton
     * Inicializa el almacenamiento para clientes y usuarios del sistema
     */
    ...
    /**
     * Proporciona acceso global a la instancia de GestorDeUsuarios
     * @return La única instancia de GestorDeUsuarios
     */
    public static synchronized GestorDeUsuarios getInstancia() {
        if (instancia == null) {
    ...
    public String getEstadisticas() {
        return String.format("Sistema - Clientes: %d, Usuarios: %d", 
                            clientes.size(), usuariosDelSistema.size());
    }
    ...
    public void limpiarDatos() {
        this.clientes.clear();
        this.usuariosDelSistema.clear();
        System.out.println("Datos del gestor de usuarios limpiados.");
    }
} 