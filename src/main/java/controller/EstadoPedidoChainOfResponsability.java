 ...
 * 
 */
public class EstadoPedidoChainOfResponsability {

    private String nombre;
    private EstadoPedidoChainOfResponsability siguienteEstado;
    private SubjectObservadorEstado subjectObservadorEstado;

    /**
     * Default constructor
     */
    public EstadoPedidoChainOfResponsability(String nombre) {
        this.nombre = nombre;
    ...
    public void actualizarEstado(String nuevoEstadoInfo) { // This method might be called internally or by a context
        ...
        System.out.println("EstadoPedidoChainOfResponsability " + this.nombre + " actualizando estado a: " + nuevoEstadoInfo);
     ...
     * 
     */
    public void setSiguienteEstado(EstadoPedidoChainOfResponsability siguiente) {
        this.siguienteEstado = siguiente;
    }

    public EstadoPedidoChainOfResponsability getSiguienteEstado() {
